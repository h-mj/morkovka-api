...
-- Started on 2018-04-04 17:07:32
...
--
-- TOC entry 221 (class 1255 OID 16864)
...
CREATE FUNCTION public.add_default_quantities_f() RETURNS trigger
	...
	INSERT INTO quantities_t VALUES (DEFAULT, NEW.id, '__ACTIVENESS__', 'a', 3);
...
--
-- TOC entry 223 (class 1255 OID 16795)
...
--
-- TOC entry 231 (class 1255 OID 16965)
...
--
-- TOC entry 219 (class 1255 OID 17001)
...
--
-- TOC entry 230 (class 1255 OID 16758)
...
--
-- TOC entry 224 (class 1255 OID 16995)
...
--
-- TOC entry 232 (class 1255 OID 16936)
...
--
-- TOC entry 227 (class 1255 OID 16987)
...
--
-- TOC entry 216 (class 1255 OID 25193)
-- Name: restrict_quantity_deletion_f(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.restrict_quantity_deletion_f() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN
	IF OLD.type != 0 THEN
		RETURN NULL;
...
ALTER FUNCTION public.restrict_quantity_deletion_f() OWNER TO postgres;
...
--
-- TOC entry 2724 (class 2604 OID 16917)
...
--
-- TOC entry 2720 (class 2604 OID 16627)
...
--
-- TOC entry 2723 (class 2604 OID 16902)
...
--
-- TOC entry 2725 (class 2604 OID 16975)
...
--
-- TOC entry 2721 (class 2604 OID 16835)
...
--
-- TOC entry 2717 (class 2604 OID 16607)
...
--
-- TOC entry 2744 (class 2606 OID 16921)
...
--
-- TOC entry 2732 (class 2606 OID 16629)
...
--
-- TOC entry 2734 (class 2606 OID 16631)
...
--
-- TOC entry 2740 (class 2606 OID 16904)
...
--
-- TOC entry 2742 (class 2606 OID 16906)
...
--
-- TOC entry 2748 (class 2606 OID 16978)
...
--
-- TOC entry 2750 (class 2606 OID 16980)
...
--
-- TOC entry 2736 (class 2606 OID 16838)
...
--
-- TOC entry 2738 (class 2606 OID 16840)
...
--
-- TOC entry 2730 (class 2606 OID 16610)
...
--
-- TOC entry 2719 (class 2606 OID 16680)
...
--
-- TOC entry 2757 (class 2620 OID 16865)
...
--
-- TOC entry 2758 (class 2620 OID 25194)
-- Name: quantities_t restrict_quantity_deletion_tr; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER restrict_quantity_deletion_tr BEFORE DELETE ON public.quantities_t FOR EACH ROW EXECUTE PROCEDURE public.restrict_quantity_deletion_f();


--
-- TOC entry 2754 (class 2606 OID 16922)
...
--
-- TOC entry 2755 (class 2606 OID 16927)
...
--
-- TOC entry 2753 (class 2606 OID 16907)
...
--
-- TOC entry 2756 (class 2606 OID 16981)
...
--
-- TOC entry 2752 (class 2606 OID 16841)
...
--
-- TOC entry 2751 (class 2606 OID 16996)
...
-- Completed on 2018-04-04 17:07:32
